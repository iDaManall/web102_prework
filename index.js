...
const unfundedString = `A total of $${totalPledged.toLocaleString()} has been raised 
for ${GAMES_JSON.length} games. Currently, ${unfundedGames} 
${unfundedGames === 1 ? 'game remains' : 'games remain'} unfunded. We need your help
to fund ${unfundedGames === 1 ? 'this amazing game!' : 'these amazing games!'}`;
